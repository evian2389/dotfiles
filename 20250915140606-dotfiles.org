...
#+NAME: config.el
#+auto_tangle: nil
#+BEGIN_SRC emacs-lisp :tangle /data/orka/dotfiles/doom-emacs/doom/config.el :mkdirp yes
...
#+NAME: emacs-init.el
#+auto_tangle: nil
#+BEGIN_SRC scheme :tangle /data/orka/dotfiles/doom-emacs/doom/init.el :mkdirp yes
...
#+auto_tangle: nil
#+BEGIN_SRC scheme :tangle /data/orka/dotfiles/doom-emacs/doom/packages.el :mkdirp yes
;; -*- no-byte-compile: t; -*-
;;; $DOOMDIR/packages.el
